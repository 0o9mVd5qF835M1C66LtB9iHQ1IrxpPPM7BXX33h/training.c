...
#define BASE_YEAR 1900									/*Başlangıç yılımızı belirliyoruz.*/			

int is_leap(int year);									/*Fonksiyon Prototiplerini yazıyoruz.*/
long date_to_sum(int day, int month, int year);
